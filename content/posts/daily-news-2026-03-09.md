...
| 排名 | 项目 | 描述 | 分类 |
|:----:|------|------|------|
| 1 | **generative-ai** | A Simple and Universal Swarm Intelligence Engine, Predicting Anything. 简洁通用的群体智能引擎，预测万物 | 🤖 AI |
| 2 | **ui** | Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 | 🤖 AI |
| 3 | **AFFiNE** | CyberStrikeAI is an AI-native security testing platform built in Go. It integrates 100+ security tools, an intelligent o... | 🤖 AI |
| 4 | **learn-claude-code** | Skills Catalog for Codex | 📦 Other |
| 5 | **ai-hedge-fund** | Grab your own sweet-looking '.is-a.dev' subdomain. | 🤖 AI |
| 6 | **notebooklm-py** | The design language that makes your AI harness better at design. | 🤖 AI |
